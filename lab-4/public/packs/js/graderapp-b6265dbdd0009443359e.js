...
window.addNewTimeSlot = function () {
  ...
  form.querySelector('#availability_start_time').value = startTime;
  form.querySelector('#availability_end_time').setAttribute('name', 'availability[' + index + '][end_time]');
  form.querySelector('#availability_end_time').value = endTime;
...
/******/ });
//# sourceMappingURL=graderapp-b6265dbdd0009443359e.js.map