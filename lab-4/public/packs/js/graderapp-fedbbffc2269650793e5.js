...
window.addNewCourse = function () {
  var courseID = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : undefined;
  ...
  form.querySelector('#course_id').setAttribute('id', 'courses[' + courseIndex + '][course_id]');

  form.querySelector('#course_delete').onclick = function () {
    window.deleteElement('courses[' + courseIndex + '][course_id]');
  };
...
window.deleteElement = function (elt) {
...
/******/ });
//# sourceMappingURL=graderapp-fedbbffc2269650793e5.js.map