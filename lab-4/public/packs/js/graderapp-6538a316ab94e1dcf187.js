...
window.addNewTimeSlot = function () {
  ...
  form.querySelector('#availability_weekday').value = startTime;
  form.querySelector('#availability_end_time').setAttribute('name', 'availability[' + index + '][end_time]');
  form.querySelector('#availability_weekday').value = endTime;
...
/******/ });
//# sourceMappingURL=graderapp-6538a316ab94e1dcf187.js.map