...
window.addNewCourse = function () {
  ...
  form.id = "";
  form.style.display = 'flex';
  form.querySelector('#availability_weekday').setAttribute('name', 'availability[' + courseIndex + '][weekday]');
  form.querySelector('#availability_start_time').setAttribute('name', 'availability[' + courseIndex + '][start_time]');
  form.querySelector('#availability_end_time').setAttribute('name', 'availability[' + courseIndex + '][end_time]');
  courseIndex++;
  var list = document.getElementById('availabilities');
  list.append(form);
};
...
/******/ });
//# sourceMappingURL=graderapp-1754f95db90558d14833.js.map