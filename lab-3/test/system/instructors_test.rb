...
class InstructorsTest < ApplicationSystemTestCase
  ...
  test "creating a Instructor" do
    ...
    fill_in "Instructor email", with: @instructor.instructor_email
    fill_in "Instructor name", with: @instructor.instructor_name
    fill_in "Meetings", with: @instructor.meetings_id
