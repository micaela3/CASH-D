...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { instructor_email: @instructor.instructor_email, instructor_name: @instructor.instructor_name, meetings_id: @instructor.meetings_id } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { instructor_email: @instructor.instructor_email, instructor_name: @instructor.instructor_name, meetings_id: @instructor.meetings_id } }
